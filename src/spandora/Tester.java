...
public class Tester {
	...
	public static int TRACK_ID = 0, ARTIST_ID = 1, RELEASE = 2, ARTIST_HOTTNESS = 3, 
			TAG = 4, NUMBER_OF_ATTRIBUTES = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		decisionTree.printTreeLeafSubsets();
...
//				pre.SONGS + ".artist_hotness, " + pre.ARTIST_TAG + ".mbtag";
//				
